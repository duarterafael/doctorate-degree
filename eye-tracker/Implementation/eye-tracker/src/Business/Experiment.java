...
public class Experiment {
	...
	private void feedQuestions() {
		...
		Question question0 = new Question("Esta é apenas uma checagem da calibração dos equipamentos\r\n",
		...
		Question question3 = new Question(
				"3)	As atividades de cadastramento do proprietário e de cadastramento de Imóvel...",
		...
		Question question4 = new Question("4)	A atividade responsável pela verificação da documentação...",
		...
		Question question5 = new Question("5)	A verificação da documentação...",
		...
		Question question6 = new Question("6)	Se a documentação estiver irregular...",
		...
		Question question7 = new Question("7)	Se a documentação estiver regular...",
				"a)	 ... a atividade \"Verificar Documentação\" é executada.\r\n"
						+ "b)	 ... o processo é cancelado em seguida.\r\n"
						+ "c)	 ... a atividade \"Agendar Avaliação\" é executada.\r\n"
						+ "d)	 ... o proprietário é notificado.",
		...
		Question question8 = new Question("8)	Quem é responsável por informar data de avaliação?",
				"a)	Setor de atendimento.\r\n" + "b)	Setor jurídico.\r\n" + "c)	Setor de corretagem.\r\n"
						+ "d)	O proprietário.",
				'A');
		questions.add(question8);

		Question question9 = new Question("9)	A corretagem após realizar a avaliação do imóvel...",
		...
		Question question11 = new Question(
				"11)	Em todo o processo, quantas possíveis mensagens o proprietário pode receber?",
				"a)	Uma mensagem.\r\n" + "b)	Três mensagens.\r\n" + "c)	Duas mensagens.\r\n" + "d)	N mensagens.",
				'D');
		questions.add(question11);

		Question question12 = new Question("12)	Quais informações são necessárias para a avaliação do imóvel?",
		...
		Question question13 = new Question("13)	O setor jurídico é responsável por quantas atividades?",
				"a)	Três atividades.\r\n" + "b)	Uma atividade.\r\n" + "c)	Oito atividades.\r\n"
						+ "d)	Quatro atividades.",
				'B');
		questions.add(question13);

		Question question14 = new Question("14)	O que gera a interrupção do processo?",
